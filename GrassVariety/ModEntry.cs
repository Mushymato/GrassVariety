...
public sealed class ModEntry : Mod
{
    ...
    public override void Entry(IModHelper helper)
    {
        ...
        helper.ConsoleCommands.Add(
            "gv-more_grass_shim_weight",
            "Set the weight for variants generated by more grass shim",
            ConsoleSetMoreGrassShimWeight
        );
    ...
    private void ConsoleSetMoreGrassShimWeight(string cmd, string[] args)
    {
        if (Config == null)
            return;
        if (args.Length == 0)
            Config.MoreGrassShimWeight = 0;
        else if (int.TryParse(args[0], out int weight))
            Config.MoreGrassShimWeight = weight;
        Log($"More grass shim weight set to {Config.MoreGrassShimWeight}");
        Helper.GameContent.InvalidateCache(AssetManager.Asset_GrassVariety);
    }
